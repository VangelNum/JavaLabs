...
public class Chromosome {
    ...
    public void hybritization(String chrom1, String chrom2) {
        int index = (int) (Math.random() * ((0.75 * chlen - 0.25 * chlen) + 1) + 0.25 * chlen);
        chrom = chrom1.substring(0, index) + chrom2.substring(index, chlen);
    }
